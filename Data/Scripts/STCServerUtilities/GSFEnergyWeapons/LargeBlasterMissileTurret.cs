...
namespace GSF.GSFPulseCannons
{
    ...
    "XLCitadelPlasmaCannonBarrel_Large", "LPlasmaTriBlasterBase_Large", "MDualPlasmaBase_Large", 
    "SDualPlasmaBase_Large", "ThorTurretBase_Large")] 

    public class LargePlasmaMissileTurret: MyGameLogicComponent
	{
